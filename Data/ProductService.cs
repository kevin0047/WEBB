    ...
    public class ProductService
    {
        ...
        public ProductService()
        {
            _products = new List<Product>
            {
                ...
                new Product { Id = 10, ImageUrl = "/images/movie5.png", Title = "Sensor Title 1", Content = "Sensor Content 1Sensor Content 1Sensor Content 1Sensor Content 1Sensor Content 1Sensor Content 1Sensor Content 1Sensor Content 1Sensor Content 1Sensor Content 1Sensor Content 1", Category = "Components", SubCategory = "Sensors", SubSubCategory = "2D Camera" },
